...
Markdown notes use a centered readable line width by default. This can be disabled under **Settings → Appearance → Readable line width** when a full-width editor is preferred.
